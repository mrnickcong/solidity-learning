...
![alt text](./images/合约接收转账.png)

合约接收转账和转账给其他地址

![alt text](./images/合约接收转账和转账给其他地址.png)

合约转账和地址转账的区别

![alt text](./images/合约转账和地址转账的区别.png)

## 数据存储位置

![alt text](./images/数据存储位置.png)

![alt text](./images/数据存储位置-storage.png)

![alt text](./images/数据存储位置-memory.png)

![alt text](./images/数据存储位置-calldata.png)

![alt text](./images/数据存储位置-对比.png)
...
![alt text](./images/函数的类型.png)

### 函数的可见性

![alt text](./images/函数的可见性.png)
...
![alt text](./images/函数的状态-1.png)

![alt text](./images/函数的状态-2.png)
![alt text](./images/函数的状态-3.png)
![alt text](./images/函数的状态-4.png)
![alt text](./images/函数的状态-5.png)
![alt text](./images/函数的状态-6.png)
...
![alt text](./images/状态修饰转换-使用例子.png)

### 函数类型变量

可以将函数定义为一个变量使用

![alt text](./images/函数类型变量.png)

![alt text](./images/函数类型变量-例子.png)

![alt text](./images/函数类型变量-删除.png)
...
![alt text](./images/返回函数-1.png)

![alt text](./images/返回函数-2.png)

## 外部函数调用

![alt text](./images/外部函数调用.png)

1. 地址转换调用
2. 合约签名低级调用

![alt text](./images/外部函数调用-举例.png)
