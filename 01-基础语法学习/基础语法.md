...
![alt text](合约接收转账和转账给其他地址.png)

合约转账和地址转账的区别

![alt text](合约转账和地址转账的区别.png)

## 数据存储位置

![alt text](数据存储位置.png)

![alt text](数据存储位置-storage.png)

![alt text](数据存储位置-memory.png)

![alt text](数据存储位置-calldata.png)

![alt text](数据存储位置-对比.png)
...
![alt text](数据存储转换-1.png)

storage -> memory

![alt text](数据存储转换-storage转到memory.png)

memory -> storage

![alt text](数据存储转换-memory转到storage1.png)

![alt text](数据存储转换-memory转到storage2.png)

calldata -> storage/memory

![alt text](数据存储转换-calldata-sm.png)
...
![alt text](函数的状态-1.png)

![alt text](函数的状态-2.png)
![alt text](函数的状态-3.png)
![alt text](函数的状态-4.png)
![alt text](函数的状态-5.png)
![alt text](函数的状态-6.png)
...
![alt text](函数类型变量-例子.png)

![alt text](函数类型变量-删除.png)
